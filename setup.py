...
__copyright__ = 'Copyright (C) 2025, RADICAL-Consulting UG'
...
base     = 'process'
name     = 'rc.%s'      % base
mod_root = 'src/rc/%s/' % base

scripts  = list(glob('bin/*'))
root     = os.path.dirname(__file__) or '.'
readme   = open('%s/README.md' % root, encoding='utf-8').read()
descr    = 'RC Process Wrapper.'
keywords = ['radical', 'consulting', 'utilities', 'process', 'wrapper']
...
setup_args = {
    ...
    'maintainer_email'   : 'andre.merzky@radical-consulting.com',
    'url'                : 'https://github.com/radical-consulting/rc.%s' % base,
    'project_urls'       : {
          'Documentation': 'https://rc%s.readthedocs.io/en/latest/'      % base,
          'Source'       : 'https://github.com/radical-consulting/%s/'   % name,
          'Issues' : 'https://github.com/radical-consulting/%s/issues'   % name,
    },
    'license'            : 'AGPL',
    'keywords'           : keywords,
    'python_requires'    : '>=3.7',
